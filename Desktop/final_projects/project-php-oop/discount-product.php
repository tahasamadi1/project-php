...
<div class="popularProducts">
    ...
    for ($parentAverage=1; $parentAverage<=ceil(((count(manageProducts::discountProduct(40))+1))/4); $parentAverage++){

        $number=1;
        $str='<div class="col-12 d-flex justify-content-center flex-wrap">';
        $maxLengthWidth=$parentAverage*4 > count(manageProducts::discountProduct(40)) ? count(manageProducts::discountProduct(40)) :$parentAverage*4;
        for ($singleCarts=($parentAverage-1)*4; $singleCarts<$maxLengthWidth; $singleCarts++){
            if (manageProducts::discountProduct(40)[$singleCarts]->discount==0){
                $str .= " <div class='col-lg-3 col-sm-6 col-12 cartPopular'>
                <div class='extrasImageParent'>                <a href='productPage.php?id=".manageProducts::discountProduct(40)[$singleCarts]->id."' data-id='".manageProducts::discountProduct(40)[$singleCarts]->id."'><div class='imageParentPopular d-flex flex-column col-12'>
                <div class='imagePrentPopular d-flex justify-content-center d-block col-12 foe'>
                    ...
                    <img src='images/product/" . manageProducts::discountProduct(40)[$singleCarts]->image_address . ".jpg' class='d-block mx-lg-auto' alt=''>
                </div>
                <div class='titlePopualrShop col-12 p-2 d-md-block d-flex justify-content-center'>
                    <span class='textTitleProduct font-size-1 text-dark'>" . manageProducts::discountProduct(40)[$singleCarts]->nameProduct . "</span>
                </div>
                <div class='col-12 d-flex py-3 ps-2 pricesPartPopular'>
                    <div class='col-6'>
                        <span class='floatLeft text-dark'>تومان</span>
                        <div class='d-flex flex-column'>
                            <span class='fw-bold ms-2 text-dark realPrice'>" . manageProducts::convertDiscount(manageProducts::discountProduct(40)[$singleCarts]->price, manageProducts::discountProduct(40)[$singleCarts]->discount) . "</span>
                            <span class='fw-bold ms-2 text-secondary defiedPrice opacity-0'>" . manageProducts::discountProduct(40)[$singleCarts]->price . "</span>
                        </div>

                    </div>
                    <div class='col-6'>
                        <div class='badgeDesfire text-dark opacity-0'>" . manageProducts::discountProduct(40)[$singleCarts]->discount . "%</div>
                    </div>
                </div>
                <div class='col-11 mx-auto d-flex sendSectionDetail'>
                    <div class='col-6 favoritesProduct'>
                        <a href='#'>
                       <i class='fas fa-shopping-cart text-secondary' data-id-product='".manageProducts::discountProduct(40)[$singleCarts]->id."'></i>
                        </a>
                    </div>
                ...
                <div class='col-12 d-flex py-3 ps-2 pricesPartPopular'>
                    <div class='col-6'>
                        ...
                        <div class='d-flex flex-column'>
                            <span class='fw-bold ms-2 text-dark realPrice'>" . manageProducts::convertDiscount(manageProducts::discountProduct(40)[$singleCarts]->price, manageProducts::discountProduct(40)[$singleCarts]->discount) . "</span>
                            <span class='fw-bold ms-2 text-secondary defiedPrice'>" . manageProducts::discountProduct(40)[$singleCarts]->price . "</span>
                        </div>

                    </div>
                    <div class='col-6'>
                        <div class='badgeDesfire text-dark'>" . manageProducts::discountProduct(40)[$singleCarts]->discount . "%</div>
                    </div>
                </div>
                <div class='col-11 mx-auto d-flex sendSectionDetail'>
                    <div class='col-6 favoritesProduct'>
