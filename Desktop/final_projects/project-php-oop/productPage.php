...
<?php if (isset($_GET["id"])){
   $res=userDashboard::productByIds($_GET["id"])

    ?>
<div class="col-lg-10 col-12 d-flex justify-content-center mx-auto d-block flex-wrap mt-5 cardsParentProduct">
    <div class="col-lg-6 col-12">
        <div class="parentImageProduct">
            <img src="images/product/<?php echo $res['image_address']?>.jpg" alt="">
        </div>
    </div>
    <div class="col-lg-6 col-12 directionRtl">
        <span class="titleProduct text-dark"><?php echo $res["nameProduct"]?></span>
        <div class="descriptionProduct text-dark">
            ...
            <div class="col-12 d-flex align-items-baseline counterProduct">
                <div class="col-3 d-flex align-items-center">
                    <div class="col-4 d-flex justify-content-end px-2 cursorPointer" data-plus="true">
                        <i class="fas fa-chevron-right"></i>
                    </div>
                    <div class="col-4">
                        <input type="text" class="w-100 h-100 text-center fieldCount" value="1" disabled>
                    </div>
                    <div class="col-4 px-2 cursorPointer" data-neg="true">
                        <i class="fas fa-chevron-left"></i>
                    </div>
                </div>
                <div class="col-3">
                    <select class="form-select form-select-lg mb-3 customClassForSelect" aria-label=".form-select-lg example" id="colorProduct">
                        <?php foreach (json_decode($res["colors"]) as $color): ?>
                            <option><?php echo $color;?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-3">
                    <select class="form-select form-select-lg mb-3 customClassForSelect" aria-label=".form-select-lg example" id="sizeProduct">
                        <?php foreach (json_decode($res["sizes"]) as $color): ?>
                            <option><?php echo $color;?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-3">
                    <div class="priceProductSpecial"><?php echo $res["price"]?></div>
                </div>
                <button class="btn btn-danger addToShoppingCart"><i class="fas fa-trash text-dark"></i></button>
            </div>
    </div>
</div>
<?php } ?>
