...
<div class="col-8 mx-auto shoppingCartProduct directionRtl text-center">
    <table class="table table-bordered shoppingCartProduct">
        <thead>
        <tr>
...
<?php if (isset($_SESSION["userInfo"])){
    echo "<div class='text-center text-danger'>* لطفا از داشبورد خود اقدام به خرید نمایید *</div>";
}
else{
    echo "<div class='text-center text-danger'>* لطفا ثبت نام نمایید *</div>";
}
?>
